...
import { Award, Leaf, Wrench, Heart } from "lucide-react";
      ...
      <Container>
        ...
        <div className="grid lg:grid-cols-2 gap-16 mb-20">
          <div>
            ...
            <p className="text-oak-600 leading-relaxed">{t("storyText")}</p>
          </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          <div className="bg-oak-800 text-white p-8 rounded-2xl">
            ...
            <p className="text-oak-300 leading-relaxed">{t("qualityText")}</p>
          </div>
